...
define('MAILBEEZ_INSTALL_SYSTEM_CHECK', 'System Prüfung');
define('MAILBEEZ_INSTALL_SYSTEM_CONFIRM', 'Einverstanden & Weiter');
define('MAILBEEZ_INSTALL_CANCEL', 'Abbrechen');

define('MAILBEEZ_INSTALL_SYSTEM_CHECK_PHP', 'PHP version 5.2 oder höher erforderlich');
...
define('MAILBEEZ_INSTALL_SYSTEM_CHECK_TEST_WRITE_PERM', 'Schreib-Rechte für das Installations-Verzeichnis');
...
define('MAILBEEZ_INSTALL_INSTALL_STEP4', 'Prüfe Dateirechte...');
...
define('MAILBEEZ_INSTALL_INSTALL_FINISH', 'Grund-Installation erfolgreich durchgeführt');

define('MAILBEEZ_INSTALL_UPDATE', 'Aktualisierung des Grund-Systemes...');
define('MAILBEEZ_INSTALL_UPDATE_FINISH', 'Aktualisierung des Grund-Systemes erfolgreich durchgeführt');
...
define('MAILBEEZ_PACKAGE_INSTALL_FINISH', 'Paket-Installation erfolgreich durchgeführt');

define('MAILBEEZ_PACKAGE_UPDATE', 'Aktualisierung des Paketes...');
define('MAILBEEZ_PACKAGE_UPDATE_FINISH', 'Aktualisierung des Paketes erfolgreich durchgeführt');
...
define('MAILBEEZ_INSTALL_PACKAGE_TITLE', 'Wählen Sie Ihr Profi-Paket');
